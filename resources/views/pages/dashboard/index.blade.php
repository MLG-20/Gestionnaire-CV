...
<div class="max-w-5xl mx-auto">
    ...
    <a href="{{ route('home') }}" class="inline-flex items-center gap-1.5 px-3 py-2 text-xs sm:text-sm font-medium text-gray-700 mb-4 sm:mb-6 hover:bg-gray-100 rounded-lg transition-colors">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8">
        <a href="{{ route('dashboard.experiences.index') }}"
           class="group bg-white rounded-xl border border-gray-200 p-4 hover:border-blue-300 hover:shadow-sm transition-all">
            ...
            <div class="text-2xl font-bold text-gray-900">{{ $user->experiences->count() }}</div>
            <div class="text-xs text-gray-500 mt-0.5">Expérience{{ $user->experiences->count() > 1 ? 's' : '' }}</div>
        </a>
        ...
        <a href="{{ route('dashboard.educations.index') }}"
           class="group bg-white rounded-xl border border-gray-200 p-4 hover:border-blue-300 hover:shadow-sm transition-all">
            ...
            <div class="text-2xl font-bold text-gray-900">{{ $user->educations->count() }}</div>
            <div class="text-xs text-gray-500 mt-0.5">Formation{{ $user->educations->count() > 1 ? 's' : '' }}</div>
        </a>
        ...
        <a href="{{ route('dashboard.skills.index') }}"
           class="group bg-white rounded-xl border border-gray-200 p-4 hover:border-blue-300 hover:shadow-sm transition-all">
            ...
            <div class="text-2xl font-bold text-gray-900">{{ $user->skills->count() }}</div>
            <div class="text-xs text-gray-500 mt-0.5">Compétence{{ $user->skills->count() > 1 ? 's' : '' }}</div>
        </a>
        ...
        <a href="{{ route('dashboard.hobbies.index') }}"
           class="group bg-white rounded-xl border border-gray-200 p-4 hover:border-blue-300 hover:shadow-sm transition-all">
            ...
            <div class="text-2xl font-bold text-gray-900">{{ $user->hobbies->count() }}</div>
            <div class="text-xs text-gray-500 mt-0.5">Loisir{{ $user->hobbies->count() > 1 ? 's' : '' }}</div>
        </a>
    </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                <div class="flex items-center justify-between mb-5">
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-bold text-blue-600">{{ round(($completedSteps / count($steps)) * 100) }}%</div>
                        <div class="text-xs text-gray-400">{{ $completedSteps }}/{{ count($steps) }} étapes</div>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route($step['route']) }}"
                       class="flex items-center gap-3 p-3 rounded-xl border transition-all group
                        ...
                        {{-- Flèche --}}
                        <svg class="w-4 h-4 {{ $step['done'] ? 'text-green-400' : 'text-gray-300 group-hover:text-blue-400' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-blue-600 to-blue-700 p-5 text-white">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            @if($user->email)
                            <div class="text-blue-200 text-xs mt-0.5">{{ $user->email }}</div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-4">
                ...
                <div class="space-y-2.5">
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <span class="text-xs text-gray-600">{{ $user->profile->phone }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <span class="text-xs text-gray-600 truncate">{{ $user->profile->address }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <span class="text-xs text-gray-600 truncate">{{ $user->profile->linkedin_url }}</span>
                    </div>
                    @endif
