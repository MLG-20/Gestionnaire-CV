...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links nav-links-desktop">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>" class="btn-outline">Se connecter</a>
                <a href="<?php echo e(route('register')); ?>" class="btn-primary-sm">Commencer — c'est gratuit</a>
            <?php else: ?>
                <a href="<?php echo e(route('dashboard.index')); ?>" class="btn-primary-sm">← Retour au dashboard</a>
    ...
    <div class="nav-mobile-menu" id="mobile-menu">
        ...
        <div class="nav-mobile-panel">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>" class="nav-mobile-link">Se connecter</a>
                <a href="<?php echo e(route('register')); ?>" class="nav-mobile-link nav-mobile-primary">Commencer — c'est gratuit</a>
            <?php else: ?>
                <a href="<?php echo e(route('dashboard.index')); ?>" class="nav-mobile-link nav-mobile-primary">← Retour au dashboard</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <section class="hero">
        <div>
            ...
            <div class="hero-cta">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('register')); ?>" class="btn-hero">Créer mon CV gratuitement</a>
                    <a href="<?php echo e(route('login')); ?>" class="btn-hero-ghost">Déjà un compte →</a>
                <?php else: ?>
                    <a href="<?php echo e(route('dashboard.index')); ?>" class="btn-hero">Accéder à mon dashboard →</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
    ...
    <section class="tpl-section">
        <div class="section-inner">
            ...
            <div class="tpl-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = array_slice(App\Models\CvSetting::availableTemplates(), 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $colors = ['#4f46e5','#0f172a','#0369a1','#7c3aed','#059669','#dc2626']; ?>
                    <div class="tpl-card tpl-c<?php echo e($i + 1); ?>">
                        <div class="tpl-preview" style="background: rgba(<?php echo e($i % 2 === 0 ? '99,102,241' : '139,92,246'); ?>,.05);">
                            <div class="tpl-mini">
                                <div class="tpl-mini-header" style="background:<?php echo e($colors[$i]); ?>;"></div>
                                <div class="tpl-mini-body">
                                    <div class="tpl-mini-line full" style="height:3px; background:<?php echo e($colors[$i]); ?>20; margin-bottom:3px;"></div>
                                    ...
                                    <div class="tpl-mini-line full" style="margin-top:4px;"></div>
                                    <div class="tpl-mini-line half"></div>
                                    <div class="tpl-mini-line full" style="margin-top:4px; height:3px; background:<?php echo e($colors[$i]); ?>30;"></div>
                                    <div class="tpl-mini-line full"></div>
                                    <div class="tpl-mini-line third"></div>
                                </div>
                            </div>
                        ...
                        <div class="tpl-info">
                            <div class="tpl-name"><?php echo e($template['name']); ?></div>
                            <div class="tpl-style"><?php echo e($template['style']); ?></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div style="text-align:center; margin-top:2.5rem;">
                <a href="<?php echo e(route('register')); ?>" class="btn-hero" style="display:inline-block;">Voir les 10 templates →</a>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section">
        <div class="cta-box">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('register')); ?>" class="btn-hero" style="display:inline-block;">Créer mon compte gratuitement</a>
            <?php else: ?>
                <a href="<?php echo e(route('dashboard.index')); ?>" class="btn-hero" style="display:inline-block;">Accéder à mon dashboard →</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </section>
...
<?php /**PATH C:\Herd\Gestion-CV\resources\views/home.blade.php ENDPATH**/ ?>