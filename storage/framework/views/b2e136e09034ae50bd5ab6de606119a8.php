...
<head>
    ...
    <title><?php echo e(config('app.name', 'Sama CV')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
...
<div class="flex min-h-screen" x-data="{ sidebarOpen: false }">
    ...
    >
        <div class="p-5 border-b border-gray-200 flex items-center justify-between">
            <a href="<?php echo e(route('dashboard.index')); ?>" class="flex items-center gap-2">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="<?php echo e(route('dashboard.profile.edit')); ?>" @click="sidebarOpen = false"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request()->routeIs('dashboard.profile.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
            ...
            <a href="<?php echo e(route('dashboard.experiences.index')); ?>" @click="sidebarOpen = false"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request()->routeIs('dashboard.experiences.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('dashboard.educations.index')); ?>" @click="sidebarOpen = false"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request()->routeIs('dashboard.educations.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('dashboard.skills.index')); ?>" @click="sidebarOpen = false"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request()->routeIs('dashboard.skills.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('dashboard.hobbies.index')); ?>" @click="sidebarOpen = false"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request()->routeIs('dashboard.hobbies.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="pt-4 mt-4 border-t border-gray-200">
                ...
                <a href="<?php echo e(route('dashboard.cv-settings.edit')); ?>" @click="sidebarOpen = false"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors
                          <?php echo e(request()->routeIs('dashboard.cv-settings.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-100'); ?>">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="pt-4 mt-4 border-t border-gray-200">
                <a href="<?php echo e(route('dashboard.help')); ?>" @click="sidebarOpen = false"
        ...
        <div class="p-4 border-t border-gray-200 space-y-3">
            <button onclick="window.location.href='<?php echo e(route('dashboard.profile.edit')); ?>'" class="w-full flex items-center gap-3 hover:opacity-75 transition-opacity cursor-pointer bg-transparent border-0 p-0">
                <img src="<?php echo e(auth()->user()->photo_url); ?>" alt="Photo" class="w-8 h-8 rounded-full object-cover flex-shrink-0">
            ...
            <div class="space-y-1 pt-2 border-t border-gray-200">
                <a href="<?php echo e(route('dashboard.profile.settings')); ?>" class="block w-full text-left text-sm text-gray-600 hover:text-gray-900 px-2 py-2 rounded hover:bg-gray-100 transition-colors">
                    Paramètres
                </a>
    ...
    <div class="flex-1 flex flex-col min-h-screen md:ml-64">
        ...
        <header class="md:hidden sticky top-0 z-10 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between shadow-sm">
            ...
            <a href="<?php echo e(route('dashboard.index')); ?>" class="flex items-center gap-1.5">
            ...
            <a href="<?php echo e(route('dashboard.cv.download')); ?>" class="p-1.5 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors" title="Télécharger PDF">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Herd\Gestion-CV\resources\views/layouts/app.blade.php ENDPATH**/ ?>